...
/// <param name="Id">
///     The identifier sent back on selection: 1-64 characters of ASCII letters,
///     digits, <c>.</c>, <c>_</c> and <c>-</c>, unique within the state.
/// </param>
...
/// <param name="ObservedTarget">
///     The target that actually exists right now, an option id or empty.
...
/// <param name="ApplicationRestartRequired">
///     Whether a running application holds the previous target,
///     so the change reaches it only on the next launch. The row says so.
/// </param>
