...
public static class SteamGameWindowActivation
{
    ...
    /// <returns>
    ///     Whether Steam's call completed in the observed generation. This does not prove
    ///     window focus or overlay recovery; the host must restore its exact selected HWND.
    /// </returns>
