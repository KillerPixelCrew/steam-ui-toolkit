...
// filled with `currentColor` so they inherit the row's text colour, and the panel's own CSS decides
...
const SteamUiIconShapes: Readonly<Record<string, readonly SteamUiIconShape[]>> = Object.freeze({
  // Per-game profile scope: an ID card, because the question the section answers is whose settings
  // these are rather than what they do.
  profile: [
    [
      "path",
      {
  ...
  // Mains power. Used for the Windows power-profile row and the plugged-in preset assignment.
  plug: [
  ...
  sun: [
    ...
    [
      "path",
      {
        d: "M11 1.5h2V5h-2V1.5Zm0 17.5h2v3.5h-2V19ZM1.5 11H5v2H1.5v-2ZM19 11h3.5v2H19v-2ZM4.22 5.64l1.42-1.42 2.47 2.47-1.42 1.42-2.47-2.47Zm11.67 11.67 1.42-1.42 2.47 2.47-1.42 1.42-2.47-2.47Zm2.47-13.09 1.42 1.42-2.47 2.47-1.42-1.42 2.47-2.47ZM4.22 18.36l2.47-2.47 1.42 1.42-2.47 2.47-1.42-1.42Z",
      },
    ],
  ],
  // Three overlapping rings for anything that picks a colour: the additive triad the lighting
  // hardware actually mixes, rather than a painter's palette it does not.
  colors: [
    [
      "path",
      {
