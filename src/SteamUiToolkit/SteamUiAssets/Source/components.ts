function createNativeComponentHost() {
    ...
    function SteamUiFrameLimitControl() {
      ...
      const slider = controlRuntime.react.createElement(controlRuntime.slider, {
        ...
        label: refreshMode
          ...
          : localizeOr(controlRuntime, "#QuickAccess_Tab_Perf_LimitFrameRate", "Frame rate limit"),
  ...
  const resolveControls = () => {
    ...
    controlRows = [
      ...
      ["valveRefreshRate", "steam-ui-valve-refresh-rate", valveRefreshRateControl, "quickSettings"],
