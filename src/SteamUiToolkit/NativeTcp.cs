...
/// <summary>
///     Flat iphlpapi interop for "which process owns this listening port".
...
///     is unit-testable from a synthetic buffer without a live socket.
/// </summary>
internal static partial class NativeTcp
{
    ...
    /// <summary>
    ///     sizeof(MIB_TCPROW_OWNER_PID): state, localAddr, localPort,
    ///     remoteAddr, remotePort, owningPid — six DWORDs.
    /// </summary>
    ...
    /// <summary>
    ///     How often the size+read pair is retried when a concurrent socket
    ///     change invalidates the size measured by the first call.
    /// </summary>
    ...
    /// <summary>
    ///     Decodes an MIB_TCPTABLE_OWNER_PID buffer: a DWORD count followed
    ...
    /// <summary>
    ///     Enumerates IPv4 TCP listeners with their owning process ids. An empty
